...
# Correct class-to-label mapping
classNames = {
    1: "100 pesos",
    2: "1000 pesos",
    3: "20 pesos",
...
# Initialize bill detection history
...
with open(csv_filename, mode="a", newline="") as file:
    ...
    writer.writerow(["Timestamp", "Denomination", "Confidence"])
...
class ObjectDetectionApp(QWidget):
    ...
    def update_frame(self):
        ...
        for r in results:
            for box in r.boxes:
                ...
                if cls in classNames and conf > 0.6:  # Confidence filter
                    ...
                    detections_to_log.append([timestamp, label, conf])
        ...
        with open(csv_filename, mode="a", newline="") as file:
            writer = csv.writer(file)
            writer.writerows(detections_to_log)

        # Save detections to database
        cursor.executemany("INSERT INTO transactions (timestamp, denomination, confidence) VALUES (?, ?, ?)", detections_to_log)
        conn.commit()
